...
public class GitUtils2 {
	
	public static String localRepoPath = "D:/yicheSpace1";
    public static String localRepoGitConfig = "D:/yicheSpace1/wp-ibitauto-user-level/.git";
    public static String remoteRepoURI = "git@gitlab.bitautotech.com:WP/hudong/wp-ibitauto-user-level.git";
    public static String localCodeDir = "D:/yicheSpace1";
